    ...
    <section id="services" className="relative py-28 px-6 overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <ScrollReveal style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: "1.5rem" }}>
          <span style={{ fontSize: "0.7rem", letterSpacing: "0.35em", color: "var(--muted)", textTransform: "uppercase" }}>04 — Readings</span>
        ...
        <ScrollReveal style={{ display: "flex", flexDirection: "column", gap: "1.5rem", marginBottom: "3.5rem" }} className="md:flex-row md:items-end md:justify-between">
          <h2 className="font-display" style={{ fontSize: "clamp(2rem, 5vw, 3.8rem)", fontWeight: 700, lineHeight: 1.05, maxWidth: 520 }}>
