export default function Footer() {
  return (
    <footer className="px-6 py-14" style={{ borderTop: "1px solid rgba(255,255,255,0.05)" }}>
...
<div className="flex gap-3">
      ...
      <div
        ...
        style={{ borderTop: "1px solid rgba(255,255,255,0.04)", fontSize: "0.72rem", color: "var(--muted)" }}
      >
